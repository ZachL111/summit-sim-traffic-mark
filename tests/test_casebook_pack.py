"""Regression checks for the summit-sim-traffic-mark casebook."""
...
from casebook.harness import assert_expected, summit_sim_traffic_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_sim_traffic_mark_summary(), assert_expected())

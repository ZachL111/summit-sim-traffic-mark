...
`summit-sim-traffic-mark` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for traffic workflows, centered on event replay, fixture event logs, and golden state snapshots.
